  ...
  return (
    <section className="bg-black">
      <div className="lg:grid lg:min-h-screen lg:grid-cols-12">
        ...
        >
          <div className="max-w-xl lg:max-w-3xl w-full flex flex-col items-center justify-center min-h-[60vh]">
            <div className="relative -mt-16 block lg:hidden">
              <a
                className="inline-flex size-16 items-center justify-center rounded-full bg-black text-white sm:size-20"
                href="#"
              >
                <span className="sr-only">Home</span>
                <svg
              ...
              <p className="mt-4 mb-4 leading-relaxed font-semibold text-gray-500">
                INTROVUE.AI is your personal AI interview coach, designed to help you ace your job interviews with confidence and ease.
              </p>
            </div>
